...
![Data can be shaped via the query editor.Steps can be renamed to make it clearer what has been transformed.](pictures/shaping_data.png){width=75%}
...
![Merging two tables into one table.](pictures/merging.png){width=40%}
...
![Linking between two tables.](pictures/linking.png){width=75%}
