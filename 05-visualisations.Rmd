...
![Some visuals are better than others when it comes to make data (and trends) clear!](pictures/simple.png)
...
![Drop down filters sit at the top of the report page, allowing for easy filtering of the visuals below.](pictures/filters.png)
...
![The order of the colours in the legend follow the order of the colours in the visual.](pictures/colours.png)
...
![Colours are consistent across multiple charts.](pictures/colours_2.png)
...
![Bookmarks can be used to save a certain state of visuals.](pictures/bookmarks.png){width=60%}
...
![Tooltips can provide more context for visuals.](pictures/tooltips.png){width=75%}
