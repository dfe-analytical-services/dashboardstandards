...
![](pictures/identify_customer.png)
...
![](pictures/identify_data.png){width=75%}
...
![An example of an operational dashboard, taken from *https://ubiq.co/analytics-blog*. The dashboard is updated regularly to display data from the last seven days, for example sign ups and site visitors.](pictures/operational-dashboard.png){width=75%}
...
![An example of a strategic dashboard, taken from *https://www.scoro.com*. The dashboard displays KPIs and provides an overview of performance within the business.](pictures/strategic-dashboard.png){width=75%}
...
![An example of an analytical dashboard, taken from *blog.oribi.io*. The dashboard allows the user to filter data and focus on areas that are important to them.](pictures/analytical_dashboard.jpg){width=75%}
